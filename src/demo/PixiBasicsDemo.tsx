...
export function PixiBasicsDemo() {
  ...
  const takeSnapshot = () => {
    ...
    const screenX = typeof window !== 'undefined' ? (window.screenX ?? (window as any).screenLeft ?? 0) : 0;
    const screenY = typeof window !== 'undefined' ? (window.screenY ?? (window as any).screenTop ?? 0) : 0;
    ...
    console.log('[PixiBasicsDemo] snapshot', next);
  };
